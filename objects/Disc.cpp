...
void Disc::letFly(double power, double uAlpha, int playerPower, int playerAccuracy) {
	...
	double randFactor = ((double)(rand()%3 - 1)/2.0)*(6 - playerAccuracy);
	double alpha = uAlpha + randFactor;//angle of attack, specified by user, modified by player accuracy
	cout << randFactor << " was the random factor" << endl;
